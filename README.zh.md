...
这个 feed 是做出来的样例，不是产品线。同样的形状我按固定价接：针对你已经在付费的
API 做定时导出，带上宁可不发也不用坏快照覆盖线上数据的守卫 ——
[hello532.github.io/services.html](https://hello532.github.io/services.html)，
或 coolun.337@gmail.com。下面「已验证 / 未验证」那一节就是你自己的活也会拿到的同一套
标准。这个仓库里的东西不需要付费，issue 和 PR 都欢迎。
